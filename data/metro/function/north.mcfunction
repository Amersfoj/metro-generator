## Create sandstone Metro tunnel from current position to 100 blocks north (negative Z)
...
fill ~1 ~ ~0 ~1 ~ ~0 minecraft:redstone_torch
fill ~ ~-100 ~0 ~ ~-1 ~0 minecraft:cut_sandstone
